---
name: practicum
description: Згенерувати з diff чекпоінта самодостатній HTML typing-практикум — передрук коду з простими поясненнями українською та покроковим гайдом по блоках. Використовуй для команди /practicum.
---
...
## Крок 4: покрокові пояснення (steps)
...
- Для кожного блоку — `note`: 1–2 речення «як дитині»: що ми зараз
  ...
  одразу поясни його простими словами. Нотатка з'являється під кодом,
  поки користувач друкує саме цей блок.
